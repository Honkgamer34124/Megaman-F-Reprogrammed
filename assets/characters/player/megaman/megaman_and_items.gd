...
func chargeeffect(animated_sprite: AnimatedSprite2D):
	if chargetimer == 0:
		animated_sprite.material.set_shader_parameter("bodyoutlcharge", colorPalette.BLACK)
		...
		if chargetimer % 10 == 1:
			...
			animated_sprite.material.set_shader_parameter(
				"bodyoutlcharge", (Vector4(135.0, 0.0, 142.0, 255.0)) / 255
			)
		...
		if chargetimer % 5 == 1:
			...
			animated_sprite.material.set_shader_parameter(
				"chargecolorI", (Vector4(0.0, 0.0, 0.0, 255.0)) / 255
			)
			animated_sprite.material.set_shader_parameter(
				"chargecolorII", (Vector4(0.0, 98.0, 247.0, 255.0)) / 255
			)
			...
			animated_sprite.material.set_shader_parameter(
				"chargecolorI", (Vector4(137.0, 233.0, 255.0, 255.0)) / 255
			)
			animated_sprite.material.set_shader_parameter(
				"chargecolorII", (Vector4(0.0, 0.0, 0.0, 255.0)) / 255
			)
			animated_sprite.material.set_shader_parameter(
				"bodyoutlcharge", (Vector4(135.0, 0.0, 142.0, 255.0)) / 255
			)
